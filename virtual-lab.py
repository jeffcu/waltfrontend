...
def save_to_pdf(output_text, filename="output.pdf"):
    ...
    for line in lines:
        ...
        # Add text and adjust position
        if y_position < margin:  # Check for footer space
            c.showPage()
            c.setFont("Helvetica", 12)
    ...
    c.drawString(margin, margin / 2, f"Generated by Jeff's AI Workshop - Version {APP_VERSION}")
