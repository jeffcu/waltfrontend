...
def save_to_pdf(output_text, filename="output.pdf"):
    ...
    c.drawCentredString(width / 2.0, height - 40, "Analysis Report")

    # Subheader
    c.setFont("Helvetica-Bold", 14)
    c.drawCentredString(width / 2.0, height - 70, "Generated by Jeff's AI Workshop")
    ...
    for line in lines:
        if y_position < 60:  # Check for footer space
            c.showPage()
            c.setFont("Helvetica", 12)
    ...
    c.drawString(50, 30, f"Generated by Jeff's AI Workshop - Version {APP_VERSION}")
